...
if ($_SERVER['REQUEST_METHOD'] == "POST") { 
  ...
  { 
    $query = "UPDATE special_offer SET offertitle = '$offertitle', offerdetail = '$offerdetail', imagepath = '$imagepath' WHERE offerid = '$offerid'";
...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == "GET") {   
    ...
    $errors = array('offerid' => '', 'offertitle' => '', 'offerdetail' => '', 'imagepath' => '', 'failure' => '');  
      ...
      $query = "SELECT offerid, offertitle, offerdetail, imagepath FROM special_offer WHERE offerid = '$offer'";
      $result = @mysqli_query($db_connection, $query);
      $offer_detail = array();
      // store data in array
